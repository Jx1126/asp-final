...
// Define props interface for the ExpensesYearly component
interface ExpensesYearlyProps {
    data: { month: string; amount: number }[]; // Array of ExpensesYearly data for each month
}

// Define the ExpensesYearly component
const ExpensesYearly: React.FC<ExpensesYearlyProps> = ({ data }) => {
