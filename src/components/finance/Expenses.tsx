                    ...
                    <tbody>
                        {data.map((expense) => (
                            <tr key={expense.month}>
                                <td className="border border-gray-300 p-2">{expense.month}</td> {/* Month name */}
                                <td className="border border-gray-300 p-2 text-right">${expense.amount.toFixed(2)}</td> {/* Expense amount */}
                            </tr>
                        ))}
                    </tbody>
                </table>
